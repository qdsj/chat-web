...
<template>
  <div class="initial-page" v-if="isInitial === false">
    <div
      v-loading="isLoading"
    ...
    >
      ...
      <transition name="el-fade-in">
        <div v-if="!isLoading" class="error-panel">
          <el-alert title="初始化失败" type="error" center :closable="false" />
          <el-button
            v-if="authError"
            type="primary"
            class="retry-btn"
