<script setup lang="ts">
  ...
  async function updateUserInfo() {
    const friend = await friendStore.getFriendById(route.query.id as string);
    friendInfo.value = {
    ...
    <div class="user-info">
      ...
      <div class="more-op">
        <el-dropdown placement="bottom-end"
          ...
          <template #dropdown>
            <el-dropdown-item v-if="friendStatus.isAccepted"
                              @click="handleBlockFriend">拉黑好友</el-dropdown-item>
            <el-dropdown-item v-if="friendStatus.isBlocked"
                              @click="handleUnblockFriend">恢复好友关系</el-dropdown-item>
          </template>
        </el-dropdown>
      </div>
    </div>
