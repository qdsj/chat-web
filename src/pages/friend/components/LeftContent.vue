...
const groupGroup = computed(() => {
  return {
    name: "群聊",
    children: (
      (friendStore.isSearching
        ? friendStore.searchedGroupList
...
const friendGroup = computed(() => ({
  ...
  children: (
    (friendStore.isSearching
      ? friendStore.searchedFriendList
...
<template>
  ...
  <!-- 联系人 or 群聊 -->
  <div v-if="!friendStore.isSearching" class="list-group-container">
    <ListGroup
  ...
  <div v-else class="list-group-container">
    <ListGroup
      :name="groupGroup.name"
      :children="groupGroup.children"
      :activePath="activePath"
