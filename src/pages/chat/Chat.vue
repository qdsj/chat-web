	...
	<Layout>
		...
		<template #left-content>
			...
			<div class="top-search">
				...
				<div class="iconfont icon-style icon-plus"
						 @click="dialogListVisible = true"></div>
			</div>
			<div class="friendList-box">
				<CreateGroup :dialogListVisible="dialogListVisible"
			...
			<splitpanes horizontal
				...
				<pane size="75">
					<div class="title-panel"
						...
						<!-- 群聊 -->
						<div v-if="chatStore.currentConversation.type == 'group'"
					...
					<el-container class="chat-container">
						<el-main class="chat-box"
							...
							<div class="messages-container"
								...
								<template v-for="msg in chatStore.currentConversation?.messages"
													:key="msg">
