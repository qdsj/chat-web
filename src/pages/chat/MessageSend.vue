...
<template>
	<div class="send-panel">
		<div class="toolbar">
			<!-- 表情包 -->
			<el-popover :visible="showEmojiPopover"
									trigger="click"
									placement="top"
									:teleported="false"
									@hide="hidePopover"
				...
				<template #reference>
					<div class="iconfont icon-chat_emoji_icon"
							 @click.stop="showEmojiPopoverHandle"></div>
				</template>
				<template #default>
					<el-tabs v-model="activeEmoji">
						<el-tab-pane v-for="emoji in emojiLists"
												 :label="emoji.name"
												 :name="emoji.name">
		...
		<div class="send-btn-panel">
			<el-popover trigger="click"
				...
				<template #reference>
					<span class="send-btn"
								@click.stop="sendMessage">发送(S)</span>
				</template>
				<template #default>
