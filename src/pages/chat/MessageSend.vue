	...
	<div class="send-panel">
		<div class="toolbar">
			...
			<el-popover
				...
				<template #reference>
					<div class="iconfont icon-chat_emoji_icon" @click.stop="showEmojiPopoverHandle"></div>
				</template>
				<template #default>
					<el-tabs v-model="activeEmoji">
						<el-tab-pane v-for="emoji in emojiLists" :label="emoji.name" :name="emoji.name">
							<div class="emoji-list">
								<div class="emoji-item" v-for="item in emoji.emojiList" @click.stop="chooseEmoji(item)">
									{{ item }}
								</div>
							</div>
						</el-tab-pane>
